...
def main() -> None:
    ...
    first = client.post("/python/v1/ai/chat", headers=AUTH_HEADERS, json=body)
    second = client.post("/python/v1/ai/chat", headers=AUTH_HEADERS, json=body)
    third = client.post("/python/v1/ai/chat", headers=AUTH_HEADERS, json=body)
